...
<section class="ng-footer-contact">
    ...
    <div class="ng-footer-links ng-footer-section">
                    ...
                    <img src="https://static.ccis.edu/sc9/img/logos/primary-white.png" alt="Columbia College logo."></img>
                    <div>
    ...
    <div class="ng-footer-address ng-footer-section">
        <ul>
            ...
            <li>Main campus: 1001 Rogers Street</li>

            <li>Columbia, MO 65216</li>

            <li>(573) 875-8700 or (800) 231-2391</li>
